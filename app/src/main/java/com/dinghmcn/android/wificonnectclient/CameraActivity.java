...
public class CameraActivity extends AppCompatActivity {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            //dhm
            reader.acquireLatestImage().getPlanes()[0].getBuffer();

            ByteBuffer buffer = reader.acquireLatestImage().getPlanes()[0].getBuffer();
            byte[] bytes = new byte[buffer.remaining()];
            buffer.get(bytes);
            setResult(RESULT_OK, new Intent().putExtra("image_data", bytes));
            finish();
        }
    };
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        private void process(CaptureResult result) {
            Log.d(TAG, "mCaptureCallback.process() mState : " + mState);
            switch (mState) {
                case STATE_PREVIEW: {
                ...
                case STATE_WAITING_LOCK: {
                    ...
                    if (afState == null) {
                        ...
                        Log.d(TAG, "666666666666666666666 afState : " + afState);
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCameraId = getIntent().getStringExtra("camera_id");
